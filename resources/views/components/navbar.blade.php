        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar2"
            ...
            <div class="offcanvas-body">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="data-d.html">DATA DONASI</a>
                    </li>
                </ul>
                <div class="right-part d-flex flex-column flex-lg-row align-items-lg-center gap-4">
                    <div class="contact-us">
                        ...
                        <span>Contact Us <br>+62 831-4448-4092</span>
                    </div>
                    <a href="#" class="btn rounded-pill donasi-btn fw-bold">DONASI SEKARANG</a>
                </div>
            </div>
